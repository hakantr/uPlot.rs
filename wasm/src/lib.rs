...
use uplot_rs::{
    ...
    SoftMinMaxAkışı, SoftMinMaxÖrneği, SparklinesBarsÖrneği, SparklineÖrneği, UplotHatası,
    ...
    sine_stream_kartı, soft_minmax_kartı, sparklines_bars_kartı, sparklines_kartı,
